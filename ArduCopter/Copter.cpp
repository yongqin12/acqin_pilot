...
// APMִ��֮ǰ��һЩ�������趨���񣬷�������ʱ�䣬�ռ�ȡ�
void Copter::setup()
{
    // Load the default values of variables listed in var_info[]s
    AP_Param::setup_sketch_defaults();
    //gcs().send_text(MAV_SEVERITY_INFO,"sewef  %d ",(int)AP::ins().backend_countc());
    // setup storage layout for copter
    StorageManager::set_layout_copter();
    // ������ע��

    init_ardupilot();//���������ڸú�����
    //scheduler.init()�������б��룬_tasks = &scheduler_tasks[0];���ҿ�����ռ�

    // initialise the main loop scheduler
    //gcs().send_text(MAV_SEVERITY_INFO,"ssssss  %d ",(int)CONFIG_HAL_BOARD);
...
void Copter::fast_loop()
{
    ...
    attitude_control->rate_controller_run();//���ʿ��ƣ�ֻҪ������������
    ...
    // run the attitude controllers rcloop获取改变的飞行模式，此处作出改变
    update_flight_mode();
